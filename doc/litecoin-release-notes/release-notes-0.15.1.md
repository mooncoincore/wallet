Mooncoin Core version *0.15.1* is now available from:

  <https://download.mooncoin.org/mooncoin-0.15.1/>
...
A number of changes to the way Mooncoin Core deals with peer connections and invalid blocks
