...
* mooncoin.conf: contains configuration settings for mooncoind or mooncoin-qt
* mooncoind.pid: stores the process id of mooncoind while running
...
* debug.log: contains debug information and general logging generated by mooncoind or mooncoin-qt
