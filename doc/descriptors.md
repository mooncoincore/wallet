# Support for Output Descriptors in Mooncoin Core

Since Mooncoin Core v0.17, there is support for Output Descriptors in the
...
on Mooncoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Mooncoin Core wallets, a convenience function `combo` is
