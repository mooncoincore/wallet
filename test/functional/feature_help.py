...
"""Verify that starting mooncoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start mooncoin with -h for help text")
        ...
        self.log.info("Start mooncoin with -version for version information")
        ...
        self.log.info("Start mooncoind with -fakearg to make sure it does not start")
