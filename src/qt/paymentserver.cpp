...
const char* BIP71_MIMETYPE_PAYMENT = "application/mooncoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/mooncoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/mooncoin-paymentrequest";
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(0, tr("Payment request error"),
                tr("Cannot start mooncoin: click-to-pay handler"));
        }
        else {
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("mooncoin://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'mooncoin://' is not a valid URI. Use 'mooncoin:' instead."),
