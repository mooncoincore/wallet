...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Mooncoin network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
        tooltip = tr("Network activity disabled.") + QString("<br>") + tr("Click to enable network activity again.");
        icon = GUIUtil::setIcon("icons/network_disabled");
    }
...
{
    labelWalletHDStatusIcon->setPixmap(platformStyle->SingleColorIcon(GUIUtil::setIcon(hdEnabled ? "icons/hd_enabled" : "icons/hd_disabled")).pixmap(STATUSBAR_ICONSIZE,STATUSBAR_ICONSIZE));
...
void BitcoinGUI::setEncryptionStatus(int status)
{
    ...
    case WalletModel::Unlocked:
        ...
        labelWalletEncryptionIcon->setPixmap(platformStyle->SingleColorIcon(GUIUtil::setIcon("icons/lock_open")).pixmap(STATUSBAR_ICONSIZE,STATUSBAR_ICONSIZE));
    ...
    case WalletModel::Locked:
        labelWalletEncryptionIcon->show();
        labelWalletEncryptionIcon->setPixmap(platformStyle->SingleColorIcon(GUIUtil::setIcon("icons/lock_closed")).pixmap(STATUSBAR_ICONSIZE,STATUSBAR_ICONSIZE));
...
void BitcoinGUI::updateProxyIcon()
{
    ...
    if (proxy_enabled) {
        if (labelProxyIcon->pixmap() == 0) {
            ...
            labelProxyIcon->setPixmap(platformStyle->SingleColorIcon(GUIUtil::setIcon("icons/proxy")).pixmap(STATUSBAR_ICONSIZE, STATUSBAR_ICONSIZE));
