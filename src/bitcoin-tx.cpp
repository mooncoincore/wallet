...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " mooncoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  mooncoin-tx [options] <hex-tx> [commands]  Update hex-encoded mooncoin transaction\n" +
            "or:     mooncoin-tx [options] -create [commands]   Create hex-encoded mooncoin transaction\n" +
            "\n";
