...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s mooncoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  mooncoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mooncoin transaction") + "\n" +
              "  mooncoin-tx [options] -create [commands]   " + _("Create hex-encoded mooncoin transaction") + "\n" +
              "\n";
