...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Mooncoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Mooncoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/mooncoincore/wallet/issues"
